<template>
  <NuxtLink :to="props.to">
    <button
        ...
        :class="className"
    >
      <Icon class="" v-if="props.prependIcon" :style="{ width: props.iconSize.width, height: props.iconSize.height }" :name="props.prependIcon" />
      <span v-if="props.title">{{ props.title }}</span>
      <Icon class="" v-if="props.appendIcon" :style="{ width: props.iconSize.width, height: props.iconSize.height }" :name="props.appendIcon" />
